...
covs_pat <- c("age_s","hivYes","sexFemale","prv_txYes","marg_casteYes","occupationUnskilled","occupationSkilled", "`occupationSalaried.selfemployed`") 
covs_detect <- c("detectionACD")
...
covs.list <- list(None = NULL, 
                  ...
                  `Patient + detection` = c(covs_pat, covs_detect),
